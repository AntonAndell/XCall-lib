...
public class SpokeTokenBase extends SpokeTokenBasic {
    public SpokeTokenBase(String _nid, String _tokenName, String _symbolName, BigInteger _decimals, BigInteger _initialSupply) {
